        ...
        : data && (
            <div className="container mx-auto mt-8 p-4  rounded-lg shadow-md">
              ...
              <div
                ...
                style={{
                  backgroundImage: `url(${data.coverPic ? `http://localhost:8800/uploads/posts/${data.coverPic}` : "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=400&fit=crop"})`,
              ...
              >
                <div className="flex items-center justify-center h-full p-4">
                  <img src={data.profilePic ? `http://localhost:8800/uploads/posts/${data.profilePic}` : "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=80&h=80&fit=crop&crop=face"}
alt="Profile Picture"
